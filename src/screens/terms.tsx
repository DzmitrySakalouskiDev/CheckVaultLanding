  ...
  return (
    <>
      ...
      <div className="legal-container">
        ...
        <h1 className="legal-title">Terms &amp; <span className="grad">Conditions</span></h1>
        <p className="legal-updated">Last updated: June 24, 2025</p>
        <div className="legal-divider" />

        <div className="legal-body">
          <p>These terms and conditions apply to the CheckVault app (hereby referred to as "Application") for mobile devices that was created by Dmitry Sokolouski (hereby referred to as "Service Provider") as a Free service.</p>
          ...
          <p>The Application incorporates Artificial Intelligence (AI) technologies to provide certain features or services. By using the Application, you acknowledge and agree that AI may be used to process data and deliver functionalities. The Service Provider ensures that all AI usage complies with applicable laws and is designed to benefit the user experience.</p>

          <p>The Service Provider may wish to update the application at some point. The application is currently available as per the requirements for the operating system may change, and you will need to download the updates if you want to continue using the application. The Service Provider does not guarantee that it will always update the application so that it is relevant to you and/or compatible with the particular operating system version installed on your device. However, you agree to always accept updates to the application when offered to you. The Service Provider may also wish to cease providing the application and may terminate its use at any time without providing termination notice to you. Unless they inform you otherwise, upon any termination, (a) the rights and licenses granted to you in these terms will end; (b) you must cease using the application, and (if necessary) delete it from your device.</p>
          ...
          <p>These terms and conditions are effective as of 2028-06-24.</p>

          <h2>Contact Us</h2>
          <p>If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at <a href="mailto:dmitrysakalouski@gmail.com">dmitrysakalouski@gmail.com</a>.</p>
        </div>
      </div>
